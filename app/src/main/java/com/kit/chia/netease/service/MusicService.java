package com.kit.chia.netease.service;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    private void initMusicDatas(Intent intent) {
        ...
        List<MusicData> musicDatas = (List<MusicData>) intent.getSerializableExtra(GlobalParameters.getPARAM_MUSIC_LIST());
        Log.i("jiawei","MusicService initMusicDatas: "+musicDatas.size());
    ...
    private void play(final int index) {
        Log.i("jiawei","MusicService initMusicDatas play: " + mMusicDatas.get(index).getMusicRes());
